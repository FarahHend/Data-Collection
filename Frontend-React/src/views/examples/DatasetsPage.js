      ...
      <div className="wrapper">
          ...
          <div className="content-center">
            <Row className="row-grid justify-content-between align-items-center text-left">
              <Col lg="6" md="6">
                ...
                Be a Data <span className="text-info">Provider</span> Today! <br />
                </h1>
                <h4 className="text-white mb-3">
                adding datasets can indeed be helpful to people in various ways ...
                </h4>
        ...
        >
          ...
          Add Datasets
              ...
              <Row>
              {files
                    .slice((currentPage - 1) * 2, currentPage * 2) // Display 2 files per page
                    .map((file, index) => (
                      <Col md="12" key={index}>
